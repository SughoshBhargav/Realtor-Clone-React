        ...
        <form>
            ...
            <div className='flex'>
                <button 
                    ...
                    value='sale' 
                    onClick={onChange}
                    className={`mr-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg transition duration-150 ease-in-out w-full ${type==='sell' ? "bg-white" : "bg-slate-600 text-white"}`}
                    >
                        SELL
                </button>
                <button 
                    ...
                    id='type' 
                    value='sale' 
                    className={`ml-3 px-7 py-3 font-medium text-sm uppercase shadow-md rounded hover:shadow-lg focus:shadow-lg active:shadow-lg transition duration-150 ease-in-out w-full ${type==='rent' ? "bg-white" : "bg-slate-600 text-white"}`} 
                    onClick={onChange}
                    >
                        RENT
                </button>
